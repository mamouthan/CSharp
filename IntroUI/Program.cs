...
namespace IntroUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double resultCalculation = calculationDictionary[getDataInput.getUserInput.choosedCalculation](getDataInput.getUserInput.numbers);
